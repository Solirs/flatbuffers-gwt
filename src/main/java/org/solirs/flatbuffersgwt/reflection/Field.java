...
public final class Field extends Table {
  ...
  public KeyValue attributesByKey(String key) { int o = __offset(22); return o != 0 ? KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public KeyValue attributesByKey(KeyValue obj, String key) { int o = __offset(22); return o != 0 ? KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public KeyValue.Vector attributesVector() { return attributesVector(new KeyValue.Vector()); }
  public KeyValue.Vector attributesVector(KeyValue.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
