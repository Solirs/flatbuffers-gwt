...
public final class RPCCall extends Table {
  ...
  public Object request() { return request(new Object()); }
  public Object request(Object obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public Object response() { return response(new Object()); }
  public Object response(Object obj) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public KeyValue attributes(int j) { return attributes(new KeyValue(), j); }
  public KeyValue attributes(KeyValue obj, int j) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int attributesLength() { int o = __offset(10); return o != 0 ? __vector_len(o) : 0; }
  public KeyValue attributesByKey(String key) { int o = __offset(10); return o != 0 ? KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public KeyValue attributesByKey(KeyValue obj, String key) { int o = __offset(10); return o != 0 ? KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public KeyValue.Vector attributesVector() { return attributesVector(new KeyValue.Vector()); }
  public KeyValue.Vector attributesVector(KeyValue.Vector obj) { int o = __offset(10); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
