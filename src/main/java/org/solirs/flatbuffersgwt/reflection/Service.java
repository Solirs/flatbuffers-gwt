...
public final class Service extends Table {
  ...
  public RPCCall calls(int j) { return calls(new RPCCall(), j); }
  public RPCCall calls(RPCCall obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int callsLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public RPCCall callsByKey(String key) { int o = __offset(6); return o != 0 ? RPCCall.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public RPCCall callsByKey(RPCCall obj, String key) { int o = __offset(6); return o != 0 ? RPCCall.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public RPCCall.Vector callsVector() { return callsVector(new RPCCall.Vector()); }
  public RPCCall.Vector callsVector(RPCCall.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public KeyValue attributesByKey(String key) { int o = __offset(8); return o != 0 ? KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public KeyValue attributesByKey(KeyValue obj, String key) { int o = __offset(8); return o != 0 ? KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
