...
public final class Enum extends Table {
  ...
  public EnumVal valuesByKey(long key) { int o = __offset(6); return o != 0 ? EnumVal.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public EnumVal valuesByKey(EnumVal obj, long key) { int o = __offset(6); return o != 0 ? EnumVal.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public EnumVal.Vector valuesVector() { return valuesVector(new EnumVal.Vector()); }
  public EnumVal.Vector valuesVector(EnumVal.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public KeyValue attributesByKey(String key) { int o = __offset(12); return o != 0 ? KeyValue.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public KeyValue attributesByKey(KeyValue obj, String key) { int o = __offset(12); return o != 0 ? KeyValue.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public KeyValue.Vector attributesVector() { return attributesVector(new KeyValue.Vector()); }
  public KeyValue.Vector attributesVector(KeyValue.Vector obj) { int o = __offset(12); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
