...
package org.solirs.flatbuffersgwt.reflection;

import org.solirs.flatbuffersgwt.BaseVector;
import org.solirs.flatbuffersgwt.Constants;
import org.solirs.flatbuffersgwt.FlatBufferBuilder;
import org.solirs.flatbuffersgwt.Table;
...
public final class Schema extends Table {
  ...
  public Object objectsByKey(String key) { int o = __offset(4); return o != 0 ? Object.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public Object objectsByKey(Object obj, String key) { int o = __offset(4); return o != 0 ? Object.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  ...
  public Enum enumsByKey(String key) { int o = __offset(6); return o != 0 ? Enum.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public Enum enumsByKey(Enum obj, String key) { int o = __offset(6); return o != 0 ? Enum.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public Enum.Vector enumsVector() { return enumsVector(new Enum.Vector()); }
  public Enum.Vector enumsVector(Enum.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public Service services(Service obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int servicesLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public Service servicesByKey(String key) { int o = __offset(14); return o != 0 ? Service.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public Service servicesByKey(Service obj, String key) { int o = __offset(14); return o != 0 ? Service.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public Service.Vector servicesVector() { return servicesVector(new Service.Vector()); }
  public Service.Vector servicesVector(Service.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public long advancedFeatures() { int o = __offset(16); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  /**
   * All the files used in this compilation. Files are relative to where
   * flatc was invoked.
   */
  public SchemaFile fbsFiles(int j) { return fbsFiles(new SchemaFile(), j); }
  public SchemaFile fbsFiles(SchemaFile obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int fbsFilesLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public SchemaFile fbsFilesByKey(String key) { int o = __offset(18); return o != 0 ? SchemaFile.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public SchemaFile fbsFilesByKey(SchemaFile obj, String key) { int o = __offset(18); return o != 0 ? SchemaFile.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public SchemaFile.Vector fbsFilesVector() { return fbsFilesVector(new SchemaFile.Vector()); }
  public SchemaFile.Vector fbsFilesVector(SchemaFile.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
